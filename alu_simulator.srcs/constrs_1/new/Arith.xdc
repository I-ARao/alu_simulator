...
#Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { Op[1] }]; #IO_L9P_T1_DQS_14 Sch=btnc Subtraction
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { Op[0] }]; #IO_L4N_T0_D05_14 Sch=btnu Addition
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { Op[2] }]; #IO_L12P_T1_MRCC_14 Sch=btnl NAND
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { Op[3] }]; #IO_L10N NOR
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { RST }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd_T1_D15_14 Sch=btnr